// Inline SVG icon library — no emoji, no external deps
// All icons are 1em × 1em by default and inherit currentColor.

import type { SVGProps } from "react";

type IconProps = SVGProps<SVGSVGElement> & { size?: number | string };

function Icon({ size = "1em", children, ...rest }: IconProps & { children: React.ReactNode }) {
  return (
    <svg
...
export function IconGoogle(p: Omit<IconProps, "stroke" | "fill">) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width={(p as IconProps).size ?? "1em"}
      height={(p as IconProps).size ?? "1em"}
      viewBox="0 0 24 24"
      aria-hidden="true"
    >
